================================================================================
    MFC 라이브러리 : SDI_test 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 SDI_test 응용 프로그램을 
만들었습니다.  이 응용 프로그램은 MFC(Microsoft Foundation Classes)의
기본적인 사용법을 보여 주며 응용 프로그램 작성을 위한 출발점을 제공합니다.

이 파일에는 SDI_test 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
SDI_test.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CSDI_testApp 응용 프로그램
    클래스를 선언합니다.

SDI_test.cpp
    응용 프로그램 클래스 CSDI_testApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\SDI_test.ico
    ...
    주 리소스 파일인 SDI_test.rc에 의해 포함됩니다.
...
res\Toolbar.bmp
    ...
    SDI_test.rc의 IDR_MAINFRAME TOOLBAR 배열을 업데이트하여 도구 모음
    단추를 추가합니다.
/////////////////////////////////////////////////////////////////////////////

응용 프로그램 마법사에서 하나의 문서 형식과 하나의 뷰가 만들어집니다.

SDI_testDoc.h, SDI_testDoc.cpp - 문서
    이 파일에는 CSDI_testDoc 클래스가 들어 있습니다.  이 파일을 편집하여
    특수한 문서 데이터를 추가하고 CSDI_testDoc::Serialize를 통해 파일
    저장 및 로드를 구현합니다.

SDI_testView.h, SDI_testView.cpp - 문서 뷰
    이 파일에는 CSDI_testView 클래스가 들어 있습니다.
    CSDI_testView 개체는 CSDI_testDoc 개체를 보는 데 사용됩니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더(PCH) 파일인 SDI_test.pch와
